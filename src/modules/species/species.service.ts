...
export class SpeciesService {
    ...
    async create(createSpeciesDto: CreateSpecieDto): Promise<Specie> {
        const newSpecie: Specie = await this.relationsCompleter.forCreate(createSpeciesDto, Specie);
    ...
    async update(id: number, updateSpeciesDto: UpdateSpecieDto): Promise<Specie> {
        const completedSpecie: Specie = await this.relationsCompleter.forUpdate(id, updateSpeciesDto, Specie);
