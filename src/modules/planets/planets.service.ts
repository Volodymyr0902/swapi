...
export class PlanetsService {
    ...
    async create(createPlanetDto: CreatePlanetDto): Promise<Planet> {
        const newPlanet: Planet = await this.relationsCompleterService.forCreate(createPlanetDto, Planet);
    ...
    async update(id: number, updatePlanetDto: UpdatePlanetDto): Promise<Planet> {
        const completedPlanet: Planet = await this.relationsCompleterService.forUpdate(id, updatePlanetDto, Planet);
